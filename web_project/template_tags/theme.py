...
def format_price(value):
    """Formate un prix au format '10 000 Fcfa' avec des espaces pour les milliers."""
    try:
        # Conversion en entier pour éviter les décimales si c'est un nombre entier
        price = int(float(value)) if float(value) == int(float(value)) else float(value)
