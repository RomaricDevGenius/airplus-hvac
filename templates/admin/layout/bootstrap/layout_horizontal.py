...
menu_file_path = settings.BASE_DIR / "templates" / "admin" / "layout" / "partials" / "menu" / "horizontal" / "json" / "horizontal_menu.json"
...
class TemplateBootstrapLayoutHorizontal:
    ...
    def init_menu_data(context):
        ...
        menu_data = json.load(menu_file_path.open(encoding="utf-8")) if menu_file_path.exists() else {"menu": []}
